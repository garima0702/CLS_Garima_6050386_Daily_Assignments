...
public class ProductCatalogueService {
    ...
    private final String PRODUCT_URL = "http://localhost:8051/products";
    private final String PRICE_URL = "http://localhost:8052/prices";
    private final String INVENTORY_URL = "http://localhost:8053/inventory";
